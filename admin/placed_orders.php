    ...
    <div class="box-container">
      ...
      <div class="box">
        ...
        <form action="" method="post">
          ...
          <div class="flex-btn">
            <input type="submit" name="update_payment" value="Actualizar" class="option-btn">
            <a href="placed_orders.php?delete=<?= $fetch_orders['id']; ?>" class="delete-btn"
              onclick="return confirm('¿Quieres eliminar este pedido?');">Eliminar</a>
          </div>
        </form>
      </div>
