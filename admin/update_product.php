...
<body>
  ...
  <section class="update-product">
    ...
    <form action="" method="post" enctype="multipart/form-data">
      ...
      <input type="text" name="name" class="box" maxlength="100" placeholder="Ingrese el nombre del producto"
        value="<?= $fetch_products['name']; ?>" required>
      <span>Actualizar precio</span>
      <input type="number" name="price" class="box" min="0" max="9999999999"
        placeholder="Ingrese el precio del producto" value="<?= $fetch_products['price'];?>"
